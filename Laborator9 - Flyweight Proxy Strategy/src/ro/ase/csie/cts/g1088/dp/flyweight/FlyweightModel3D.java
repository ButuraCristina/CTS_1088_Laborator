...
public class FlyweightModel3D implements InterfataFlyweightModel3D{
	...
	// cand alegem importul mereu e din java.util
	...
	public void afisareEcran(DateEcran date) {
		System.out.println(String.format("Afisare %s la coordonatele %d,%d,%d cu %s", numeModel, date.x, date.y, date.z, date.textura));
